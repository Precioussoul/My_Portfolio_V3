          ...
          <div className='flex flex-col gap-5 w-full'>
            ...
            <div className='w-full '>
              ...
              >
                ...
                <div className='relative overflow-hidden overflow-x-scroll w-full hide-scroll'>
                  <div className='w-[500px] '>
                    <div className='flex gap-4 animate-scroll group-hover:pause-scroll w-full '>
                      {/* Repeat your tech cards here */}
                      {[
