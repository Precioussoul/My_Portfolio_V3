...
export const testimonialData: TestimonialProps[] = [
  ...
  },
  {
    ...
    author_speech:
      "As a UX designer, I've worked with Sofiyullah to create Connou's new website. From my experience, Sofiyulla is a tireless and highly motivated professional, always willing to learn and improve his skills. It was a pleasure to work and learn together.",
  ...
  },
  {
    ...
    author_speech:
      "Always available to help, incredibly proficient, hits deadlines without fail, hard working and trustworthy. In my experience, no project is too much trouble, and with Sofiyullah you really get a rare entity – someone that can simplify what can be very complex at times and provide a valuable opinion that best fit. I can recommend his services without hesitation to anybody.",
  ...
  },
  {
    ...
    author_speech:
      "I worked as a UX designer with Sofiyullah on a web development project and he is a joy to work with. I was surprised by how quickly he understood the deliverables and his perfect implementation of my designs. He knows his onions and is an asset to any team.",
  ...
  },
  {
    ...
    author_speech:
      "Sofiyullah is a multi-talented, multi-skilled developer. I have had the privilege to work with him on the first luluwebsite. He has provided us with his time, advice and expertise professionally. Delivery was neat and an exact implementation of what our design team prototyped. Will work with and recommend him anytime.",
  ...
  },
  {
    ...
    author_speech:
      "Sofiyullah Abdullah is one of the best developers I've seen, he's my personal mentor, very professional and hardworking and willing to learn. I'll personally recommend him for any Frontend development role. He's always been a superb developer.",
  ...
  },
  {
    ...
    author_speech:
      "Sofiyullah is highly enthusiastic, motivated and self-driven. Sofiyullah is as well selfless and team-driven. He is at all times, willing to share his knowledge and as well encourage his peers through pep talks.",
  ...
  },
  {
    ...
    author_speech:
      "Sofiyullah is well-versed with problem-solving skills, he is a good communicator who knows why things work the way they do. His knowledge of cloud tools makes him stand out among peers and he is a good team player.",
